...
<!--                        &lt;!&ndash;<el-button type="primary" @click="testDataSource">测试连接</el-button>&ndash;&gt;-->
...
<!--                container_id: "viz",-->
<!--                //neo4j服务器地址，用户名 和 密码-->
<!--                server_url: "bolt://http://localhost:7474/",-->
<!--                server_user: "neo4j",-->
...
<!--                //配置数据库查询语句，MATCH n RETURN n,尝试过不对，必须用 MATCH p=()&ndash;&gt;() RETURN p-->
<!--                initial_cypher: 'MATCH p=()&ndash;&gt;() RETURN p',-->
<!--            };-->
