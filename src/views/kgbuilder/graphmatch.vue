...
<template>
    <div class="mind-box">
        ...
        <div class="mind-con">
            ...
            <div class="mind-top clearfix">
                ...
                <div v-show="domain != ''" class="fl" style="display: flex">
                    <div class="search">
                        ...
                        <el-input placeholder="请输入关键词" v-model="nodeName"
                            @keyup.enter.native="getDomainGraph"></el-input>
                    </div>
                    <span>
                        <span class="dibmr">
                            <span>显示节点个数:</span>
                            <el-tag v-for="(m, index) in pageSizeList" size="mini" :key="index"
                                :type="m.isActive ? 'success' : ''" class="tag-ml-5" @click="setMatchSize(m)">{{ m.size
                                }}</el-tag>
                        </span>
                    </span>
                </div>
            ...
            <!-- 头部over -->
            <!-- 中部 -->
            <div class="mind-cen" id="graphcontainerdiv">
                ...
                <div id="graphContainer" class="graphContainer">
                    <kgbuilder ref="kg_builder" :styles="style" :initData="graphData" :domain="domain"
                        :domainId="domainId" :ring-function="RingFunction" @editForm="editForm" />
                </div>
            </div>
            <!-- 中部over -->
...
import KGBuilderTwo from "@/components/KGBuilderTwo";
...
export default {
    ...
    data() {
        return {
            ...
            domain: "skillandknowledge",
            domainId: 0,
            domainAlia: "skillandknowledge",
            nodeName: "",
            pageSize: 500,
            activeNode: null,
            nodeImageList: [],
